    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-greenBase text-white py-5 font-montserrat">
      <div className="container mx-auto px-4 py-2 flex justify-between items-center md:text-xs lg:text-base">
        ...
        <div className="hidden md:flex gap-10 items-center">
          <Link href="#news" className="text-beigeBase hover:text-yellowBase">TRANG CHỦ</Link>
          <Link href="#categories" className="text-beigeBase hover:text-yellowBase">DANH MỤC</Link>
          <Link href="#about" className="text-beigeBase hover:text-yellowBase">VỀ CHÚNG TÔI</Link>
          <Link href="#contact" className="text-beigeBase hover:text-yellowBase">LIÊN HỆ</Link>
        </div>
